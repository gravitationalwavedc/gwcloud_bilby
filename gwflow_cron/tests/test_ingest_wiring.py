    ...
    def test_end_to_end_mocked_run(self, mock_gwc_cls, mock_jc_cls, mock_portal_cls, mock_fetch):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with (
                ...
                self.assertLess(log_output.index("Starting phase_metadata"), log_output.index("Starting phase_file_mirror"))
                self.assertLess(log_output.index("Starting phase_file_mirror"), log_output.index("Starting phase_bilby_children"))
