...
REGISTRY = (
    _contract(
        ...
        swap="innerHTML",
        kwargs="no_kwargs",
        focus=FocusExpectation("explicit_pagination_heading", "#gwflow-results-heading"),
        capabilities=frozenset({"loading", "announcement", "race", "history", "focus"}),
    ...
    _contract(
        ...
        swap="innerHTML",
        kwargs="no_kwargs",
        focus=FocusExpectation("explicit_pagination_heading", "#my-jobs-results-heading"),
        capabilities=frozenset({"loading", "announcement", "race", "history", "focus"}),
        async_states=frozenset({"empty", "error"}),
        announcing={"content": "status", "empty": "status"},
    ),
    _contract(
        ...
        swap="innerHTML",
        kwargs="no_kwargs",
        focus=FocusExpectation("explicit_pagination_heading", "#public-jobs-results-heading"),
        capabilities=frozenset({"loading", "announcement", "race", "history", "focus"}),
        async_states=frozenset({"empty", "error"}),
        announcing={"content": "status", "empty": "status"},
    ),
