...
class TestApiTokenViews(BilbyTestCase):
    url = "/htmx-preview/api-tokens/"
    create_url = "/htmx-preview/api-tokens/create/"
    ...
    def test_unauthenticated_redirected(self):
        ...
        self.assertEqual(response["Location"], "/sso/login/?next=/htmx-preview/api-tokens/")
    ...
    def test_revoke_token(self):
        ...
        revoke_url = f"/htmx-preview/api-tokens/{token.id}/revoke/"
