...
urlpatterns = [
    ...
    path("jobs/<str:job_id>/", views.view_job_root_redirect, name="view_job_root"),
    path(
        "jobs/<str:job_id>/parameters/",
        views.view_job_section,
        {"section": "parameters"},
        name="view_job_parameters_section",
    ),
    path(
        "jobs/<str:job_id>/results/",
        views.view_job_section,
        {"section": "results"},
        name="view_job_results_section",
    ),
    path("job-results/<str:job_id>/", views.view_job_root_redirect, name="view_job"),
    ...
    path(
        "gwflow/<str:sname>/files/",
        views.gwflow_job_detail_view,
        {"section": "files"},
        name="gwflow_job_files",
    ),
    path("gwflow/files/<uuid:token>/download/", views.gwflow_file_download, name="gwflow_file_download"),
    path(
        "gwflow/<str:sname>/metadata/",
        views.gwflow_job_detail_view,
        {"section": "metadata"},
        name="gwflow_job_metadata",
    ),
    path(
        "gwflow/<str:sname>/history/",
        views.gwflow_job_detail_view,
        {"section": "history"},
        name="gwflow_job_history",
    ),
    path(
        "gwflow/<str:sname>/history/<str:history_id>/",
