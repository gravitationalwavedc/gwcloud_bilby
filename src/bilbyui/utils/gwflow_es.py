                ...
                analyses.append(
                    {
                        ...
                        "type": analysis_type,
                        "software": str(
                            item.get("inference_software") or item.get("software") or ""
                        ),
                        "waveform": str(
                            item.get("waveform_approximant") or item.get("waveform") or ""
                        ),
    ...
    try:
        ...
        if isinstance(gracedb_section, dict):
            ...
            gracedb_doc["gpsTime"] = str(
                gracedb_section.get("preferred_event_gps")
                or gracedb_section.get("gps_time")
                or ""
            )
            gracedb_doc["far"] = str(
                gracedb_section.get("preferred_event_far")
                or gracedb_section.get("far")
                or ""
            )
            gracedb_doc["instruments"] = str(
                gracedb_section.get("instruments") or ""
            )
    except Exception as e:
