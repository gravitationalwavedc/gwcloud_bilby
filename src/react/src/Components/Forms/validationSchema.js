...
let validationSchema = Yup.object().shape({
  ...
  hanfordMinimumFrequency: Yup.number()
    .max(
      Yup.ref("hanfordMaximumFrequency"),
      "This should be less than maximum frequency."
    )
    .required(),
  hanfordMaximumFrequency: Yup.number()
    .min(
      Yup.ref("hanfordMinimumFrequency"),
      "This should be greater than minimum frequency."
    )
    .required(),
  hanfordChannel: Yup.string().nullable(),
  virgoMinimumFrequency: Yup.number()
    .max(
      Yup.ref("virgoMaximumFrequency"),
      "This should be less than maximum frequency."
    )
    .required(),
  virgoMaximumFrequency: Yup.number()
    .min(
      Yup.ref("virgoMinimumFrequency"),
      "This should be greater than minimum frequency."
    )
    .required(),
  ...
  livingstonMinimumFrequency: Yup.number()
    .max(
      Yup.ref("livingstonMaximumFrequency"),
      "This should be less than maximum frequency."
    )
    .required(),
  livingstonMaximumFrequency: Yup.number()
    .min(
      Yup.ref("livingstonMinimumFrequency"),
      "This should be greater than minimum frequency."
    )
    .required(),
