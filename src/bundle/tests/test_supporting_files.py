...
class TestSupportingFiles(TestCase):
    ...
    def test_psd1(self):
        ...
        self.responses.add(
            ...
            body=open('./data/psd.txt', 'rb').read(),
            status=200
        )
    ...
    def test_timeslide_gps_file(self):
        ...
        self.responses.add(
            responses.GET,
            f"https://gwcloud.org.au/bilby/file_download/?fileId={token}",
            body=open('./data/gps_file_for_timeslides.txt', 'rb').read(),
            status=200
        )
        ...
        self.responses.add(
            responses.GET,
            f"https://gwcloud.org.au/bilby/file_download/?fileId={token2}",
            body=open('./data/timeslides.txt', 'rb').read(),
            status=200
        )
    ...
    def test_injection_file(self):
        ...
        self.responses.add(
            responses.GET,
            f"https://gwcloud.org.au/bilby/file_download/?fileId={token}",
            body=open('./data/test_injection.json', 'rb').read(),
            status=200
        )
